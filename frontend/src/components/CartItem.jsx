...
export const CartItem = ({item}) => {
  ...
  return (
    <div className='rounded-lg border p-4 shadow-sm border-gray-700 bg-gray-800 md:p-6'>
        <div className='space-y-4 md:flex md:otems-center md:justify-between md:gap-6 md:space-y-0'>
            <div className='shrink-0 md:order-1'>
                <img src={item.image} className='h-20  w-40 md:h-32 rounded object-cover' />
            </div>
            {/* <label htmlFor="" className='sr-conly'>Choose quantity:</label> */}
            ...
            <div className='w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-2-md'>
